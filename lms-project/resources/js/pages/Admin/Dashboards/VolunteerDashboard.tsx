...
export default function VolunteerDashboard({ stats }: Props) {
    return (
        <div className="space-y-6">
                ...
                <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <div>
                        ...
                        <p className="mt-4 max-w-2xl text-slate-300">
                            Track assignments, attendance, programs and volunteer
            ...
            <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-4">
                ...
                <StatCard
                    ...
                    value="2"
                    icon={
                        <HandHelping className="h-6 w-6 text-violet-600" />
                    }
                />
            ...
            <div className="grid gap-6 lg:grid-cols-2">
                ...
                <div className="rounded-2xl border p-6">
                    ...
                    <ul className="space-y-3">
                        ...
                        <li>• Weekend Teaching Support</li>
                        <li>• Student Registration Assistance</li>
                    </ul>
                </div>
                ...
                <div className="rounded-2xl border p-6">
                    ...
                    <div className="space-y-5">
                        ...
                        <div className="flex items-start gap-4">
                            ...
                            <div>
                                <p className="font-medium">
                                    Program participation recorded
                                </p>
