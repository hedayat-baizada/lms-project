...
export default function AcademicDashboard({ stats }: Props) {
    return (
                ...
                <div className="relative z-10 flex flex-col lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <div>
                        ...
                        <p className="mt-4 max-w-2xl text-slate-300">
                            Manage academic programs, courses, curriculum,
                            attendance tracking and student learning outcomes.
                        </p>
                    </div>
            ...
            <div className="grid gap-6 lg:grid-cols-2">
                ...
                <div className="rounded-2xl border p-6">
                    ...
                    <ul className="space-y-3">
                        ...
                        <li>• Evaluate attendance trends</li>
                        <li>• Assess student academic performance</li>
                    </ul>
                </div>
