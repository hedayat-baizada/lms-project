...
export default function Dashboard() {
    ...
    // --- FIX: مثل app-sidebar.tsx، نقش کاربر باید از آرایه roles خوانده شود
    // نه از ستون role مفرد (که در بک‌اند شما هیچ‌وقت پر نمی‌شود چون
    // سیستم Spatie Permission نقش‌ها را در جدول جدا نگه می‌دارد).
